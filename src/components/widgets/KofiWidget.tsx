import { KofiData } from "@/types/widget-types";
...
export function KofiWidget({ data, size, variant, isOwner, deleteWidget, editWidget }: KofiWidgetProps) {

  const onClick = () => {
    const url = "https://ko-fi.com/" + data.username;
