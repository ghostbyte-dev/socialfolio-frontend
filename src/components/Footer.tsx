    ...
    <footer className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 container px-5">
        <div className="mt-8">
          ...
          <p className="text-slate-400 text-sm">Link All Your Socials in Style</p>
        </div>
        ...
        <div className="mt-8">
          ...
          <nav className="text-slate-400 text-sm space-y-1 flex flex-col">
            <Link href="https://techhub.social/@socialfolio" className="hover:text-white">
            Mastodon
          </Link>
          <Link href="https://github.com/ghostbyte-dev/socialfolio-frontend" className="hover:text-white">
            Github
          </Link>
